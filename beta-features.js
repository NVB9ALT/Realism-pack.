...
var promptOpen = true;
addonChat.innerHTML = '<li><iframe id="realismChat", width="1000", height="1500", left=350,top=50, src="https://chat.hyperjs.ml/GeoFS", title="Addon chat"</iframe></li>';
...
setTimeout(() => {promptOpen = true}, 1000)
  }
})
