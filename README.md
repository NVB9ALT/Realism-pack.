# Realism-pack
This is a **fork** of the NVB9 Realism addon. This edited addon will transform GeoFS into something like Xplane or MSFS. The project is being planned.
...
- Stall/Master Caution Oral/Visual Callouts
- Terrian Terrian Pull Up GPWS System Oral/Visual
- Makes some of the cockpits more realistic (not including CC aircraft) such as B737
- Interactive cockpits in some of aircraft such as B737, A330, B777
- Force on aircraft is calculated, so some of the aircraft parts may break off when extreme forces are applied on aircraft
- 3D Google Earth Buildings (must have HD)
- Functioning gates
- Pressurization for some aircraft
- ATC Roleplay will include voice chat
- Realistic camera shots for movie/trailers on GeoFS
...
Make sure you use the latest version of this; I update this addon **probably never because if it's size**.
