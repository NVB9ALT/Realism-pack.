function realismGo() {
    ...
    geofs.debug.loadMSGprop = function() {
       geofs.debug.MsGprop || geofs.debug.createMsGprop()
        try {
            var c = V3.add(geofs.aircraft.instance.llaLocation, xyz2lla([0, 0, 0], geofs.aircraft.instance.llaLocation)),
                d = [M33.getOrientation(geofs.aircraft.instance.object3d._rotation)[0], M33.getOrientation(geofs.aircraft.instance.object3d._rotation)[1] + (geofs.animation.values.enginesOn == 1 ? geofs.animation.values.rpm/100 : 0), M33.getOrientation(geofs.aircraft.instance.object3d._rotation)[2]];
