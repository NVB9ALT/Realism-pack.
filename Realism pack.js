...
function runBladeCollisions() {if (geofs.aircraft.instance.id == 9 || geofs.aircraft.instance.id == 52 || geofs.aircraft.instance.id == 2840 || geofs.aircraft.instance.id == 4090) {
/*code here*/
}};bladeCollisionInterval = setInterval(function(){runBladeCollisions()}, 1000);

function runSensitivityFix() {if (geofs.aircraft.instance.id == 9 || geofs.aircraft.instance.id == 52 || geofs.aircraft.instance.id == 2840 || geofs.aircraft.instance.id == 4090) {
/*code here*/
}};sensitivityFixInterval = setInterval(function(){runSensitivityFix()}, 1000);
...
var script2 = document.createElement('script'); script2.src="https://cdn.jsdelivr.net/gh/NVB9ALT/GeoFS-Aircraft-Changes@main/Aircraft-fixesX.js";document.body.appendChild(script2);script2.onload = function(){realismify()};
